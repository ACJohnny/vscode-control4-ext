import { C4Property, C4Action, C4Command, C4Connection, C4Event, C4Proxy, C4UI, C4NavDisplayOption, C4InterfaceSearch } from '../control4';
...
export const SearchResource      = new Component<C4InterfaceSearch>('search.c4c', C4InterfaceSearch);